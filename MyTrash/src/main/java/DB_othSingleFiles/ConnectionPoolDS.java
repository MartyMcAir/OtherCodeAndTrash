...
//        Statement stmt2=null;
        ...
        try (Statement stmt2 = new_con.createStatement()) {
            ResultSet rs = stmt2.executeQuery("select version()");

            if (rs.next()) System.out.println("Database Version : " + rs.getString(1));
