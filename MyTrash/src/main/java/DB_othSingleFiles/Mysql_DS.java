 ...
 * @author MartyMcAir
 */
// 2018 новый подход к созданию подкючения к MySQL БД через Data Source
public class Mysql_DS {
    // init database constants _ РАБОЧИЙ ВАРИАНТ
