...
/* 
Р—РЅР°РЅРёСЏ - СЃРёР»Р°!
 */
public class Solution {

    public static void main(String[] args) {
        List<Stock> stocks = getStocks(); // РїРѕР»СѓС‡Р°РµРј Р·Р°РїРѕР»РЅРµРЅРЅС‹Р№ СЃРїРёСЃРѕРє
        sort(stocks);
    ...
    public static void printStocks(List<Stock> stocks, Date actualDate) {
        ...
        double[] filelimits = {0d, actualDate.getTime()}; // РґРёРѕРїР°Р·РѕРЅ С‡РёСЃРµР»  ChoiceFormat'a
        String[] filepart = {"change {4}", "open {2} and last {3}"}; // РІР°СЂРёР°РЅС‚С‹ СЃС‚СЂРѕРє, РєРѕС‚РѕСЂС‹Рµ РјРѕРіСѓС‚ Р±С‹С‚СЊ РёСЃРїРѕР»СЊР·РѕРІР°РЅС‹
