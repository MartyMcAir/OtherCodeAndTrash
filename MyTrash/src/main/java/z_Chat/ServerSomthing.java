...
/**
 * класс хранящий в ссылочном приватном списке информацию о последних 10 (или
 * меньше) сообщениях
 */
class Story {
    ...
    /**
     * отсылаем последовательно каждое сообщение из списка в поток вывода
     * данному клиенту (новому подключению)
     *
     * @param writer
     */
